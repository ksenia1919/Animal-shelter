...
void __fastcall TForm1::Image2Click(TObject *Sender)
{
    if(Edit1->Text == "" && Edit2->Text == "" && Edit3->Text == "" && Edit4->Text == "" && Edit5->Text == "")
	{
		...
		ShowMessage("Для регистрации требуется заполнить все поля.");
	}
	else
	{
	int count_registr = 0;
	...
	if(Edit2->Text != "")
	{
		...
		else
		{
			...
			ShowMessage("Е-mail введен некоректно.");
		}
	}
	else
	{
		Application->Title="Внимание!";
		ShowMessage("Пожалуйста, введите ваш E-mail.");
	}
	///Edit3
	if(Edit3->Text != "")
	{
	...
	{
		Application->Title="Внимание!";
		ShowMessage("Пожалуйста, повторите свой пароль.");
	}
	...
	if(Edit1->Text != "" && Edit2->Text != "" && Edit3->Text != "" && Edit4->Text != "" && Edit5->Text != "" ) {
		if(count_registr == 5)
		{
			...
			ADOQuery1->Fields->FieldByName("Тип пользователя")->AsString = "Пользователь";
			ADOQuery1->Post();
			Form2->Show();
			Form1->Hide();
			count_registr = 0;
